...
public class Mail {
    ...
    public Mail(JavaMailSender mailSender, StringRedisTemplate stringRedisTemplate) {
    ...
    public void sendVerfMail(String receiveMail){
        ...
        message.setFrom("15520441865@163.com");//发送者.
        message.setTo(receiveMail);//接收者.
        message.setSubject("(重要！)Ofms验证邮件");//邮件主题.
        message.setText("您的验证码是："+verNum+"\n"+"请注意：验证码在5分钟内有效，请注意时限！");//邮件内容.
        System.out.println(String.valueOf(verNum));
